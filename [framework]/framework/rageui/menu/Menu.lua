...
function RageUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.Rectangle = nil
    Menu.Pagination = { Minimum = 1, Maximum = RageUI.MaxPagination, Total = RageUI.MaxPagination }
    Menu.Safezone = true
...
-- function RageUI.Menus:DoesInstructionButtonExist(button)
--     if self.InstructionalButtons then
--         for i=1, #self.InstructionalButtons do
--             if self.InstructionalButtons[i][2] == button[2] then
--                 return true
--             end
--         end
--     end
...
function RageUI.Menus:AddInstructionButton(button)
    if type(button) == "table" and #button == 2 then
        -- if self:DoesInstructionButtonExist(button) then
        --     return
        -- end
